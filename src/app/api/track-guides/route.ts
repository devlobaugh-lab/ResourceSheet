...
const createTrackGuideSchema = z.object({
  ...
  suggested_drivers: z.array(z.string().uuid()).optional().default([]),
...
export async function POST(request: NextRequest) {
  try {
    ...
    const trackGuideData: Inserts<'user_track_guides'> = {
      ...
      driver_1_dry_strategy: validatedData.driver_1_dry_strategy,
      driver_1_wet_strategy: validatedData.driver_1_wet_strategy,
      driver_2_dry_strategy: validatedData.driver_2_dry_strategy,
      driver_2_wet_strategy: validatedData.driver_2_wet_strategy,
